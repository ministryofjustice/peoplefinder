...
describe AllUserRolesQuery, versioning: true do
  ...
  let!(:person3) do
    adrian = create :person, given_name: 'Adrian', surname: 'Smith', email: 'adrian.smith@digital.justice.gov.uk', login_count: 3, last_login_at: Time.new(2016, 05, 21, 3, 3, 3)
  ...
  describe '#call' do
    ...
    it 'returns expected records' do
      expect(subject).to match_array([person1, person2, person3])
    end
  end
  ...
  describe '#data' do
    ...
    let(:expected_collections) do
      [
        ...
        },
        {
          ...
          ancestors: nil,
          login_count: 2,
          last_login_at: Time.new(2017, 05, 21, 2, 2, 2),
          updates_count: 0
        },
        {
          id: person3.id,
          ...
          ancestors: nil,
          login_count: 3,
          last_login_at: Time.new(2016, 05, 21, 3, 3, 3),
          updates_count: 2
        }
      ]
    end
    ...
    it 'returns expected collections' do
      ap subject
      ap expected_collections
